...
from rag_haystack.prompts.simple_prompt import PROMPT


class Inference:
    def __init__(self, doc_store_path: str):
        self.doc_store_apth = doc_store_path
        self.pipeline = Pipeline()
        self.retriever = InMemoryEmbeddingRetriever(self.get_docs(path=doc_store_path))
